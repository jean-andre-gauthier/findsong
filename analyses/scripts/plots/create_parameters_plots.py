...
def create_parameters_plot(parameters_plot_path):
    ...
    plt.suptitle("Matcher peformance with varying indexer parameters", fontsize=12, y=0.02)
    ...
    create_plot(xs_fanout, "--fanout", ys1_fanout, "Recognition rate in %", ys2_fanout, "Average match score", axes[0])
    ...
    create_plot(xs_peakDeltaF, "--peakDeltaF", ys1_peakDeltaF, "Recognition rate in %", ys2_peakDeltaF, "Average match score", axes[1])
    ...
    create_plot(xs_peakDeltaT, "--peakDeltaT", ys1_peakDeltaT, "Recognition rate in %", ys2_peakDeltaT, "Average match score", axes[2])
    ...
    create_plot(xs_peaksPerChunk, "--peaksPerChunk", ys1_peaksPerChunk, "Recognition rate in %", ys2_peaksPerChunk, "Average match score", axes[3])
    ...
    create_plot(xs_windowDeltaF, "--windowDeltaF", ys1_windowDeltaF, "Recognition rate in %", ys2_windowDeltaF, "Average match score", axes[4])
    ...
    create_plot(xs_windowDeltaT, "--windowDeltaT", ys1_windowDeltaT, "Recognition rate in %", ys2_windowDeltaT, "Average match score", axes[5])

    xs_windowDeltaTi = np.array([1, 5, 10, 15, 20, 25, 30])
    ys1_windowDeltaTi = np.array([97, 97, 97, 97, 97, 97, 97])
    ys2_windowDeltaTi = np.array([96.18, 95.86, 95.75, 95.24, 94.89, 93.72, 88.74])
    create_plot(xs_windowDeltaTi, "--windowDeltaTi", ys1_windowDeltaTi, "Recognition rate in %", ys2_windowDeltaTi, "Average match score", axes[6])
