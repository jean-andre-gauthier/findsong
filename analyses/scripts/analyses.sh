...
python workspace/scala/findsong/analyses/scripts/create_audio_filters_clips.py --audiofilternames highpass lowpass rubberband rubberband rubberband rubberband rubberband rubberband rubberband rubberband rubberband rubberband rubberband rubberband rubberband rubberband chorus aecho flanger aphaser --audiofilterparameters "f=440" "f=440" "-p 0" "-p 1" "-p 2" "-p 3" "-p 4" "-p 5" "-p 6" "-t 1.0" "-t 1.025" "-t 1.05" "-t 1.075" "-t 1.1" "-t 1.125" "-t 1.15" "0.7:0.9:55:0.4:0.25:2" "0.8:0.8:1000:0.8" "delay=20:depth=5:regen=10:speed=2" "delay=5.0:speed=2.0" --inputfilesglob "workspace/scala/findsong/analyses/data/clips/audio_filters/clean/*.mp3" --outputdirectorypath workspace/scala/findsong/analyses/data/clips/audio_filters
...
# Plots
python workspace/scala/findsong/analyses/scripts/plots/create_performance_plot.py --inputfilepath workspace/scala/findsong/analyses/data/performance/performance_by_index_size --outputplotindexerpath workspace/scala/findsong/analyses/data/plots/performance_indexer.png --outputplotmatchespath workspace/scala/findsong/analyses/data/plots/performance_matcher.png
python workspace/scala/findsong/analyses/scripts/plots/create_recognition_rate_plot.py --inputfilepath workspace/scala/findsong/analyses/data/recognition_rate/recognition_rate_for_matches --outputplotpath workspace/scala/findsong/analyses/data/plots/recognition_rate.png
python workspace/scala/findsong/analyses/scripts/plots/create_blog_plots.py --digitizationplotfilename workspace/scala/findsong/analyses/data/plots/blog_digitisation.png  --fftplotfilename workspace/scala/findsong/analyses/data/plots/blog_fft.png --indexerwalkthroughplotfilename workspace/scala/findsong/analyses/data/plots/blog_indexer_walkthrough.png --matcherwalkthroughplotfilename workspace/scala/findsong/analyses/data/plots/blog_matcher_walkthrough.png
python workspace/scala/findsong/analyses/scripts/plots/create_audio_filter_plots.py --audiofilterplotpath workspace/scala/findsong/analyses/data/plots/audio_filter.png --pitchplotpath workspace/scala/findsong/analyses/data/plots/audio_filter_pitch.png --tempoplotpath workspace/scala/findsong/analyses/data/plots/audio_filter_tempo.png
python workspace/scala/findsong/analyses/scripts/plots/create_parameters_plots.py --parametersplotpath workspace/scala/findsong/analyses/data/plots/parameters.png
